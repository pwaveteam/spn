...
const[data,setData]=useState<DataRow[]>(noticeMockData)
...
const newRow:DataRow={id:newId,title:item.title,author:item.author,date:today,views:0,fileAttach:!!item.fileUpload}

...
const statusChip=(st:ApprovalStatus)=>({결재대기:"bg-[#FFF8EF] text-[#EE680F]",결재완료:"bg-[#DEFBE8] text-[#1F5F36]",결재중:"bg-[#FFF8EF] text-[#EE680F]",반려:"bg-[#FEE2E2] text-[#DC2626]"}[st])
...
const inbox:ApprovalItem[]=[{id:1,title:"위험성평가 결과서 승인",counterpart:"홍길동",date:"2025-08-17",status:"결재완료"},{id:2,title:"특별안전점검 계획 결재",counterpart:"박철수",date:"2025-08-16",status:"결재대기"},{id:3,title:"신규 화학물질 등록 요청",counterpart:"최안전",date:"2025-08-15",status:"결재완료"},{id:4,title:"보호구 교체 예산안",counterpart:"박근로",date:"2025-08-14",status:"결재대기"},{id:5,title:"정기점검 결과 보고",counterpart:"이안전",date:"2025-08-13",status:"결재대기"},{id:6,title:"감전 위험개선 조치서",counterpart:"오근로",date:"2025-08-12",status:"결재완료"},{id:7,title:"작업허가서 제도 개선(안)",counterpart:"최근로",date:"2025-08-11",status:"반려"},{id:8,title:"밀폐공간 작업절차 개정",counterpart:"홍딩동",date:"2025-08-10",status:"결재완료"},{id:9,title:"안전보건 관리규정 개정(안)",counterpart:"홍길동",date:"2025-08-09",status:"결재완료"},{id:10,title:"화재감지 설비 점검 보고",counterpart:"김근로",date:"2025-08-08",status:"결재완료"}]
const sent:ApprovalItem[]=[{id:11,title:"법정교육 이수 보고",counterpart:"김근로",date:"2025-08-17",status:"결재중"},{id:12,title:"기계가드 개선 공사 발주",counterpart:"홍길동",date:"2025-08-16",status:"결재대기"},{id:13,title:"비상대응 훈련 결과 보고",counterpart:"김근로",date:"2025-08-15",status:"결재완료"},{id:14,title:"소화설비 정비 계획",counterpart:"홍길동",date:"2025-08-14",status:"결재중"},{id:15,title:"낙상방지 난간 설치 요청",counterpart:"김근로",date:"2025-08-13",status:"결재대기"},{id:16,title:"유해물질 보관장 개보수 승인",counterpart:"홍길동",date:"2025-08-12",status:"결재중"},{id:17,title:"TBM 운영 개선안",counterpart:"홍길동",date:"2025-08-11",status:"반려"},{id:18,title:"안전보건 목표/계획 승인",counterpart:"홍길동",date:"2025-08-10",status:"결재완료"},{id:19,title:"보호구 지급 현황 보고",counterpart:"홍길동",date:"2025-08-09",status:"결재완료"},{id:20,title:"위험물 저장소 개선 계획",counterpart:"박반장",date:"2025-08-08",status:"결재대기"}]
...
const openDetail=(item:ApprovalItem)=>{if(tab==="inbox"){const row:ReceivedDetail={id:item.id,date:item.date,type:"결재문서",content:item.title,drafter:item.counterpart,status:item.status as "결재대기"|"결재완료"|"반려"};setModal({variant:"received",row})}else{const row:SentDetail={id:item.id,date:item.date,document:item.title,status:item.status,progress:"-",finalApprover:item.counterpart};setModal({variant:"sent",row})}}

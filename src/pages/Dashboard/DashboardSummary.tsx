...
const RangeToggle:React.FC<{value:RangeKey;onChange:(v:RangeKey)=>void}>=({value,onChange})=>(<div className="ml-auto inline-flex rounded-md border border-gray-200 bg-white overflow-hidden text-[11px]"><button type="button" aria-pressed={value==="7d"} onClick={()=>onChange("7d")} className={`px-2.5 py-1 leading-none transition outline-none focus-visible:ring-1 focus-visible:ring-gray-300 ${value==="7d"?"bg-gray-100 text-gray-900 font-medium":"text-gray-600 hover:bg-gray-50 hover:text-gray-800"}`}>최근 7일</button><button type="button" aria-pressed={value==="6m"} onClick={()=>onChange("6m")} className={`px-2.5 py-1 leading-none transition outline-none focus-visible:ring-1 focus-visible:ring-gray-300 border-l border-gray-200 ${value==="6m"?"bg-gray-100 text-gray-900 font-medium":"text-gray-600 hover:bg-gray-50 hover:text-gray-800"}`}>6개월</button></div>)

...
{key:"work",label:"공정(작업)",minWidth:50,align:"left"},
...
<Button variant="secondary"onClick={()=>navigate("/risk-assessment/methods/threestep/step2")}className="py-3">저장 후 다음으로<ChevronRight size={18}className="ml-2"/></Button>
</div>

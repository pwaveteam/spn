...
{key:"work",label:"공정(작업)",minWidth:90,align:"left"},
{key:"hazard",label:"유해위험요인",minWidth:600,align:"left"},
{key:"law",label:"관련법규",minWidth:230,align:"left"},
{key:"action",label:"현재 안전보건조치",minWidth:650,align:"left"},
...
const{handleDelete,handleAdd,handleSave}=useTableActions({
data,
...
<Button variant="secondary"onClick={()=>navigate("/risk-assessment/methods/frequency/step2")}className="py-3">저장 후 다음으로<ChevronRight size={18}className="ml-2"/></Button>
</div>

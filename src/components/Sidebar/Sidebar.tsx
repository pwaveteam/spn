...
onClick={handleNavClick}
className={({isActive})=>`group flex items-center gap-3 font-medium text-base h-[50px] px-3 rounded-lg transition-colors overflow-hidden ${isActive?STYLES.text.active:`${STYLES.item.text} ${STYLES.text.hover}`}`}
end
>
{({isActive})=>(
<>
...
className={`group flex items-center gap-3 py-2 px-3 rounded-lg text-[15px] font-medium ${STYLES.text.supportNormal} ${STYLES.text.hover} transition-colors overflow-hidden`}
>
...
to={item.path}
onClick={handleNavClick}
className={({isActive})=>`group flex items-center gap-3 py-2 px-3 rounded-lg text-[15px] font-medium transition-colors overflow-hidden ${isActive?STYLES.text.active:`${STYLES.text.supportNormal} ${STYLES.text.hover}`}`}
>
{({isActive})=>(
<>
